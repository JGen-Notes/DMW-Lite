 ...
 * @generated
 */
public class YClassImpl extends YMemberImpl implements YClass
{
  /**
   ...
   * @ordered
   */
  protected JvmTypeReference superclass;
   ...
   * @generated
   */
  public JvmTypeReference getSuperclass()
  {
    return superclass;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSuperclass(JvmTypeReference newSuperclass, NotificationChain msgs)
  {
    JvmTypeReference oldSuperclass = superclass;
    superclass = newSuperclass;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LangPackage.YCLASS__SUPERCLASS, oldSuperclass, newSuperclass);
   ...
   * @generated
   */
  public void setSuperclass(JvmTypeReference newSuperclass)
  {
    if (newSuperclass != superclass)
    {
      NotificationChain msgs = null;
      if (superclass != null)
        msgs = ((InternalEObject)superclass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LangPackage.YCLASS__SUPERCLASS, null, msgs);
      if (newSuperclass != null)
        msgs = ((InternalEObject)newSuperclass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LangPackage.YCLASS__SUPERCLASS, null, msgs);
      msgs = basicSetSuperclass(newSuperclass, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LangPackage.YCLASS__SUPERCLASS, newSuperclass, newSuperclass));
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case LangPackage.YCLASS__SUPERCLASS:
        setSuperclass((JvmTypeReference)newValue);
        return;
      case LangPackage.YCLASS__ENTITY_REF:
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case LangPackage.YCLASS__SUPERCLASS:
        setSuperclass((JvmTypeReference)null);
        return;
      case LangPackage.YCLASS__ENTITY_REF:
