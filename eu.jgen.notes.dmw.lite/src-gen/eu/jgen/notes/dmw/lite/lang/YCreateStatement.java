 ...
 *   <li>{@link eu.jgen.notes.dmw.lite.lang.YCreateStatement#getSetBlock <em>Set Block</em>}</li>
 *   <li>{@link eu.jgen.notes.dmw.lite.lang.YCreateStatement#getSuccess <em>Success</em>}</li>
 *   <li>{@link eu.jgen.notes.dmw.lite.lang.YCreateStatement#getAlreadyExist <em>Already Exist</em>}</li>
 * </ul>
 *
...
public interface YCreateStatement extends YStatement
{
   ...
   * @see eu.jgen.notes.dmw.lite.lang.LangPackage#getYCreateStatement_SetBlock()
   * @model containment="true"
   * @generated
   */
  YBlock getSetBlock();
  ...
  /**
   * Sets the value of the '{@link eu.jgen.notes.dmw.lite.lang.YCreateStatement#getSetBlock <em>Set Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.jgen.notes.dmw.lite.lang.LangPackage#getYCreateStatement_Success()
   * @model containment="true"
   * @generated
   */
  YBlock getSuccess();
  ...
  /**
   * Sets the value of the '{@link eu.jgen.notes.dmw.lite.lang.YCreateStatement#getSuccess <em>Success</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.jgen.notes.dmw.lite.lang.LangPackage#getYCreateStatement_AlreadyExist()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link eu.jgen.notes.dmw.lite.lang.YCreateStatement#getAlreadyExist <em>Already Exist</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
