...
public interface YAnnotAttr extends YAnnotEntityInner, YAnnotIdInner
{
  ...
  /**
   * Returns the value of the '<em><b>Yclass</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Yclass</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Yclass</em>' containment reference.
   * @see #setYclass(JvmTypeReference)
   * @see eu.jgen.notes.dmw.lite.lang.LangPackage#getYAnnotAttr_Yclass()
   * @model containment="true"
   * @generated
   */
  JvmTypeReference getYclass();

  /**
   * Sets the value of the '{@link eu.jgen.notes.dmw.lite.lang.YAnnotAttr#getYclass <em>Yclass</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Yclass</em>' containment reference.
   * @see #getYclass()
   * @generated
   */
  void setYclass(JvmTypeReference value);
