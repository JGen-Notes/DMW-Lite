...
public class LangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getYAnnotAccess().getTypeAlternatives_1_0(), "rule__YAnnot__TypeAlternatives_1_0");
			builder.put(grammarAccess.getYAnnotTopAccess().getTypeAlternatives_0(), "rule__YAnnotTop__TypeAlternatives_0");
			builder.put(grammarAccess.getYAnnotDefaultTypeAccess().getAlternatives(), "rule__YAnnotDefaultType__Alternatives");
			...
			builder.put(grammarAccess.getYAnnotColumnAccess().getAnnotsAlternatives_6_0(), "rule__YAnnotColumn__AnnotsAlternatives_6_0");
			...
			builder.put(grammarAccess.getYPackageDeclarationAccess().getGroup(), "rule__YPackageDeclaration__Group__0");
			...
			builder.put(grammarAccess.getYPropertyAccess().getGroup_7(), "rule__YProperty__Group_7__0");
			...
			builder.put(grammarAccess.getYFunctionAccess().getGroup_6(), "rule__YFunction__Group_6__0");
			builder.put(grammarAccess.getYReadStatementAccess().getGroup(), "rule__YReadStatement__Group__0");
			builder.put(grammarAccess.getYReadStatementAccess().getGroup_3(), "rule__YReadStatement__Group_3__0");
			builder.put(grammarAccess.getYReadStatementAccess().getGroup_5(), "rule__YReadStatement__Group_5__0");
			...
			builder.put(grammarAccess.getYAnnotAccess().getGroup(), "rule__YAnnot__Group__0");
			builder.put(grammarAccess.getYAnnotLengthAccess().getGroup(), "rule__YAnnotLength__Group__0");
			builder.put(grammarAccess.getYAnnotMaxAccess().getGroup(), "rule__YAnnotMax__Group__0");
			builder.put(grammarAccess.getYAnnotDecimalAccess().getGroup(), "rule__YAnnotDecimal__Group__0");
			builder.put(grammarAccess.getYAnnotDefaultAccess().getGroup(), "rule__YAnnotDefault__Group__0");
			builder.put(grammarAccess.getYAnnotActionAccess().getGroup(), "rule__YAnnotAction__Group__0");
			builder.put(grammarAccess.getYAnnotMessageAccess().getGroup(), "rule__YAnnotMessage__Group__0");
			builder.put(grammarAccess.getYAnnotMsgTypeAccess().getGroup(), "rule__YAnnotMsgType__Group__0");
			builder.put(grammarAccess.getYAnnotEntityAccess().getGroup(), "rule__YAnnotEntity__Group__0");
			builder.put(grammarAccess.getYAnnotEntityAccess().getGroup_2(), "rule__YAnnotEntity__Group_2__0");
			builder.put(grammarAccess.getYAnnotAttrAccess().getGroup(), "rule__YAnnotAttr__Group__0");
			builder.put(grammarAccess.getYAnnotRelAccess().getGroup(), "rule__YAnnotRel__Group__0");
			builder.put(grammarAccess.getYAnnotRelAccess().getGroup_8(), "rule__YAnnotRel__Group_8__0");
			builder.put(grammarAccess.getYAnnotIdAccess().getGroup(), "rule__YAnnotId__Group__0");
			builder.put(grammarAccess.getYAnnotIdAccess().getGroup_5(), "rule__YAnnotId__Group_5__0");
			...
			builder.put(grammarAccess.getDBExpressionAccess().getGroup(), "rule__DBExpression__Group__0");
			builder.put(grammarAccess.getDBOrExpressionAccess().getGroup(), "rule__DBOrExpression__Group__0");
			builder.put(grammarAccess.getDBOrExpressionAccess().getGroup_1(), "rule__DBOrExpression__Group_1__0");
			builder.put(grammarAccess.getDBOrExpressionAccess().getGroup_1_0(), "rule__DBOrExpression__Group_1_0__0");
			builder.put(grammarAccess.getDBOrExpressionAccess().getGroup_1_0_0(), "rule__DBOrExpression__Group_1_0_0__0");
			builder.put(grammarAccess.getDBAndExpressionAccess().getGroup(), "rule__DBAndExpression__Group__0");
			builder.put(grammarAccess.getDBAndExpressionAccess().getGroup_1(), "rule__DBAndExpression__Group_1__0");
			builder.put(grammarAccess.getDBAndExpressionAccess().getGroup_1_0(), "rule__DBAndExpression__Group_1_0__0");
			builder.put(grammarAccess.getDBAndExpressionAccess().getGroup_1_0_0(), "rule__DBAndExpression__Group_1_0_0__0");
			builder.put(grammarAccess.getDBEqualityExpressionAccess().getGroup(), "rule__DBEqualityExpression__Group__0");
			builder.put(grammarAccess.getDBEqualityExpressionAccess().getGroup_1(), "rule__DBEqualityExpression__Group_1__0");
			builder.put(grammarAccess.getDBEqualityExpressionAccess().getGroup_1_0(), "rule__DBEqualityExpression__Group_1_0__0");
			builder.put(grammarAccess.getDBEqualityExpressionAccess().getGroup_1_0_0(), "rule__DBEqualityExpression__Group_1_0_0__0");
			builder.put(grammarAccess.getDBRelationalExpressionAccess().getGroup(), "rule__DBRelationalExpression__Group__0");
			...
			builder.put(grammarAccess.getYWidgetAccess().getPackageAssignment_1(), "rule__YWidget__PackageAssignment_1");
			builder.put(grammarAccess.getYWidgetAccess().getImportSectionAssignment_2(), "rule__YWidget__ImportSectionAssignment_2");
			builder.put(grammarAccess.getYWidgetAccess().getAnnotationsAssignment_3(), "rule__YWidget__AnnotationsAssignment_3");
			builder.put(grammarAccess.getYWidgetAccess().getClassesAssignment_4(), "rule__YWidget__ClassesAssignment_4");
			builder.put(grammarAccess.getYPackageDeclarationAccess().getNameAssignment_2(), "rule__YPackageDeclaration__NameAssignment_2");
			...
			builder.put(grammarAccess.getYClassAccess().getMembersAssignment_6(), "rule__YClass__MembersAssignment_6");
			builder.put(grammarAccess.getYPropertyAccess().getAccessAssignment_0(), "rule__YProperty__AccessAssignment_0");
			builder.put(grammarAccess.getYPropertyAccess().getNameAssignment_2(), "rule__YProperty__NameAssignment_2");
			builder.put(grammarAccess.getYPropertyAccess().getTypeAssignment_4(), "rule__YProperty__TypeAssignment_4");
			builder.put(grammarAccess.getYPropertyAccess().getTuplesAssignment_5(), "rule__YProperty__TuplesAssignment_5");
			builder.put(grammarAccess.getYPropertyAccess().getOptionalAssignment_6(), "rule__YProperty__OptionalAssignment_6");
			builder.put(grammarAccess.getYPropertyAccess().getAttrRefAssignment_7_1(), "rule__YProperty__AttrRefAssignment_7_1");
			builder.put(grammarAccess.getYPropertyAccess().getAnnotationsAssignment_8(), "rule__YProperty__AnnotationsAssignment_8");
			...
			builder.put(grammarAccess.getYFunctionAccess().getTypeAssignment_6_1(), "rule__YFunction__TypeAssignment_6_1");
			builder.put(grammarAccess.getYFunctionAccess().getBodyAssignment_7(), "rule__YFunction__BodyAssignment_7");
			builder.put(grammarAccess.getYReadStatementAccess().getStructsAssignment_2(), "rule__YReadStatement__StructsAssignment_2");
			builder.put(grammarAccess.getYReadStatementAccess().getStructsAssignment_3_1(), "rule__YReadStatement__StructsAssignment_3_1");
			builder.put(grammarAccess.getYReadStatementAccess().getJoinclauseAssignment_4(), "rule__YReadStatement__JoinclauseAssignment_4");
			builder.put(grammarAccess.getYReadStatementAccess().getWhereclauseAssignment_5_1(), "rule__YReadStatement__WhereclauseAssignment_5_1");
			builder.put(grammarAccess.getYReadStatementAccess().getSuccessExpressionsAssignment_8(), "rule__YReadStatement__SuccessExpressionsAssignment_8");
			builder.put(grammarAccess.getYReadStatementAccess().getNotfoundExpressionsAssignment_13(), "rule__YReadStatement__NotfoundExpressionsAssignment_13");
			...
			builder.put(grammarAccess.getYCreateStatementAccess().getStructAssignment_2(), "rule__YCreateStatement__StructAssignment_2");
			builder.put(grammarAccess.getYCreateStatementAccess().getSetExpressionsAssignment_4(), "rule__YCreateStatement__SetExpressionsAssignment_4");
			builder.put(grammarAccess.getYCreateStatementAccess().getSuccessExpressionsAssignment_8(), "rule__YCreateStatement__SuccessExpressionsAssignment_8");
			builder.put(grammarAccess.getYCreateStatementAccess().getAlreadyExistExpressionsAssignment_13(), "rule__YCreateStatement__AlreadyExistExpressionsAssignment_13");
			...
			builder.put(grammarAccess.getYAssociateStatementAccess().getJoinrefAssignment_1(), "rule__YAssociateStatement__JoinrefAssignment_1");
			...
			builder.put(grammarAccess.getYAnnotAccess().getTypeAssignment_1(), "rule__YAnnot__TypeAssignment_1");
			builder.put(grammarAccess.getYAnnotTopAccess().getTypeAssignment(), "rule__YAnnotTop__TypeAssignment");
			builder.put(grammarAccess.getYAnnotLengthAccess().getLengthAssignment_3(), "rule__YAnnotLength__LengthAssignment_3");
			builder.put(grammarAccess.getYAnnotMaxAccess().getLengthAssignment_3(), "rule__YAnnotMax__LengthAssignment_3");
			builder.put(grammarAccess.getYAnnotDecimalAccess().getLengthAssignment_3(), "rule__YAnnotDecimal__LengthAssignment_3");
			builder.put(grammarAccess.getYAnnotDecimalAccess().getDecimalAssignment_5(), "rule__YAnnotDecimal__DecimalAssignment_5");
			builder.put(grammarAccess.getYAnnotDefaultAccess().getTypeAssignment_3(), "rule__YAnnotDefault__TypeAssignment_3");
			builder.put(grammarAccess.getYAnnotDefaultTextAccess().getValueAssignment(), "rule__YAnnotDefaultText__ValueAssignment");
			builder.put(grammarAccess.getYAnnotDefaultNumberAccess().getValueAssignment(), "rule__YAnnotDefaultNumber__ValueAssignment");
			builder.put(grammarAccess.getYAnnotActionAccess().getActionAssignment_3(), "rule__YAnnotAction__ActionAssignment_3");
			builder.put(grammarAccess.getYAnnotMessageAccess().getMsgAssignment_3(), "rule__YAnnotMessage__MsgAssignment_3");
			builder.put(grammarAccess.getYAnnotMsgTypeAccess().getMsgtypeAssignment_2(), "rule__YAnnotMsgType__MsgtypeAssignment_2");
			builder.put(grammarAccess.getYAnnotEntityAccess().getNameAssignment_1(), "rule__YAnnotEntity__NameAssignment_1");
			builder.put(grammarAccess.getYAnnotEntityAccess().getSuperannotAssignment_2_1(), "rule__YAnnotEntity__SuperannotAssignment_2_1");
			builder.put(grammarAccess.getYAnnotEntityAccess().getAnnotsAssignment_4(), "rule__YAnnotEntity__AnnotsAssignment_4");
			builder.put(grammarAccess.getYAnnotAttrAccess().getNameAssignment_2(), "rule__YAnnotAttr__NameAssignment_2");
			builder.put(grammarAccess.getYAnnotAttrAccess().getYclassAssignment_4(), "rule__YAnnotAttr__YclassAssignment_4");
			builder.put(grammarAccess.getYAnnotAttrAccess().getOptionalAssignment_5(), "rule__YAnnotAttr__OptionalAssignment_5");
			builder.put(grammarAccess.getYAnnotAttrAccess().getAnnotsAssignment_6(), "rule__YAnnotAttr__AnnotsAssignment_6");
			builder.put(grammarAccess.getYAnnotRelAccess().getParentAssignment_2(), "rule__YAnnotRel__ParentAssignment_2");
			builder.put(grammarAccess.getYAnnotRelAccess().getNameAssignment_3(), "rule__YAnnotRel__NameAssignment_3");
			builder.put(grammarAccess.getYAnnotRelAccess().getOptionalAssignment_4(), "rule__YAnnotRel__OptionalAssignment_4");
			builder.put(grammarAccess.getYAnnotRelAccess().getTargetAssignment_6(), "rule__YAnnotRel__TargetAssignment_6");
			builder.put(grammarAccess.getYAnnotRelAccess().getManyAssignment_7(), "rule__YAnnotRel__ManyAssignment_7");
			builder.put(grammarAccess.getYAnnotRelAccess().getInverseAssignment_8_1(), "rule__YAnnotRel__InverseAssignment_8_1");
			builder.put(grammarAccess.getYAnnotIdAccess().getNameAssignment_2(), "rule__YAnnotId__NameAssignment_2");
			builder.put(grammarAccess.getYAnnotIdAccess().getAnnotsAssignment_4(), "rule__YAnnotId__AnnotsAssignment_4");
			builder.put(grammarAccess.getYAnnotIdAccess().getAnnotsAssignment_5_1(), "rule__YAnnotId__AnnotsAssignment_5_1");
			...
			builder.put(grammarAccess.getYAnnotColumnAccess().getAnnotsAssignment_6(), "rule__YAnnotColumn__AnnotsAssignment_6");
			...
			builder.put(grammarAccess.getDBOrExpressionAccess().getFeatureAssignment_1_0_0_1(), "rule__DBOrExpression__FeatureAssignment_1_0_0_1");
			builder.put(grammarAccess.getDBOrExpressionAccess().getRightOperandAssignment_1_1(), "rule__DBOrExpression__RightOperandAssignment_1_1");
			builder.put(grammarAccess.getDBAndExpressionAccess().getFeatureAssignment_1_0_0_1(), "rule__DBAndExpression__FeatureAssignment_1_0_0_1");
			builder.put(grammarAccess.getDBAndExpressionAccess().getRightOperandAssignment_1_1(), "rule__DBAndExpression__RightOperandAssignment_1_1");
			builder.put(grammarAccess.getDBEqualityExpressionAccess().getFeatureAssignment_1_0_0_1(), "rule__DBEqualityExpression__FeatureAssignment_1_0_0_1");
			builder.put(grammarAccess.getDBEqualityExpressionAccess().getRightOperandAssignment_1_1(), "rule__DBEqualityExpression__RightOperandAssignment_1_1");
			builder.put(grammarAccess.getDBRelationalExpressionAccess().getLeftOperandAssignment_0(), "rule__DBRelationalExpression__LeftOperandAssignment_0");
			builder.put(grammarAccess.getDBRelationalExpressionAccess().getRightOperandAssignment_1(), "rule__DBRelationalExpression__RightOperandAssignment_1");
