...
public class LangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getYWidgetAccess().getAnnotationsAssignment_2(), "rule__YWidget__AnnotationsAssignment_2");
			builder.put(grammarAccess.getYWidgetAccess().getClassesAssignment_3(), "rule__YWidget__ClassesAssignment_3");
			...
			builder.put(grammarAccess.getYPropertyAccess().getAnnotationsAssignment_6(), "rule__YProperty__AnnotationsAssignment_6");
